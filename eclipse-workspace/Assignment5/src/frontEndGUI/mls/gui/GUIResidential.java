...
public class GUIResidential {
	...
	private JPanel getTopLeftCenterPanelResidential() {
		...
		cbSearchByResidential.addItem("Legal Description");
	...
	private class MyActionListenerResidential implements ActionListener  {
		...
		public void actionPerformed(ActionEvent e) {
				...
				if(e.getSource() == btnSearchResidential) {
					...
					if(listModelResidential.size() >0) 
					{
					...
					switch(cbSearchByResidential.getSelectedItem().toString()) 
					{
						case "Id":
							...
							searchResultResidential = (ArrayList<ResidentialProperty>) rpb.search(residential.getId() + "", "id");
						...
						case "Asking Price":
							...
							searchResultResidential = (ArrayList<ResidentialProperty>) rpb.search(residential.getAskingPrice() + "", "price");
							for(ResidentialProperty rp : searchResultResidential) {
								listModelResidential.addElement(rp.getId()+ " " + rp.getAddress() + " " + rp.getZone());
							}
							break;
						/*case "Number of Bedrooms":
							...
							searchResultResidential = (ArrayList<ResidentialProperty>) rpb.search(residential.getBedrooms());
							for(ResidentialProperty rp : searchResultResidential) {
								listModelResidential.addElement(rp.getId()+ " " + rp.getAddress() + " " + rp.getZone());
							}
							break;*/
						...
						case "Quadrant":
							...
							searchResultResidential = (ArrayList<ResidentialProperty>) rpb.search(residential.getQuadrant(), "quadrant");
							for(ResidentialProperty rp : searchResultResidential) {
								listModelResidential.addElement(rp.getId()+ " " + rp.getAddress() + " " + rp.getZone());
							}
							break;
						...
						try {
							residential.setLegalDescription(tfSearchResidential.getText());
						} catch (InvalidLegalDescriptionException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
							searchResultResidential = (ArrayList<ResidentialProperty>) rpb.search(residential.getLegalDescription() + "", "legal description");
							for(ResidentialProperty rp : searchResultResidential) {
								listModelResidential.addElement(rp.getId()+ " " + rp.getAddress() + " " + rp.getZone());
							}
							break;
