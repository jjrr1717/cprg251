...
public class MyFrame {
	...
	/**
	 * actionListener is an ActionListener that determines which button is clicked
	 * to display either the Client, Residential, or Commercial panel
	 */
	private ActionListener actionListener;
	/**
	 * btnClient is a JButton to get to the client panel
	 */
	private JButton btnClient;
	/**
	 * btnResidential is a JButton to get to the Residential panel.
	 */
	private JButton btnResidential;
	/**
	 * btnCommerical is a JButton to get to the Commercial button.
	 */
	...
	/**
	 * panelList is an ArrayList of JPanels, to hold the Client, Residential, and
	 * Commercial Panels.
	 */
	private ArrayList<JPanel> panelList;

	/**
	 * guiClient is an object of the GUIClient class to get access to the contents
	 * of the Client panel.
	 */
	private GUIClient guiClient;
	/**
	 * guiCResidential is an object of the GUIResidential class to get access to the
	 * contents of the Residential panel.
	 */
	private GUIResidential guiResidential;
	/**
	 * guiCommerical is an object of the GUICommerical class to get access to the
	 * contents of the Commerical panel.
	 */
	private GUICommercial guiCommercial;

	/**
	 * cb is an object of the ClientBroker to have access to the methods in the
	 * ClientBroker.
	 */
	private ClientBroker cb;
	/**
	 * rpb is an object of the ResidentialPropertyBroker to have access to the
	 * methods in that class
	 */
	private ResidentialPropertyBroker rpb;
	/**
	 * cpb is an object of the CommercialPropertyBroker to have access to the
	 * methods in that class
	 */
	private CommercialPropertyBroker cpb;

	/**
	 * Constructor. Has the initialize() method to display the GUI
	 */
	public MyFrame() {
		initialize();
	}
	...
	/**
	 * initialize is a method to set up the JFrame for the GUI. Setup the bounds of
	 * the JFrame. Add the Client, Residential, and Commerical panels.
	 */
	...
	/**
	 * getNorthPanel contains the JPanel and components of the Client, Residential,
	 * and Commerical buttons at the top of the GUI.
	 * 
	...
	/**
	 * MyActionListener listens for if the Client, Residential, or Commerical
	 * buttons are clicked. It will change to the panel of whatever button was
	 * clicked.
	 * 
	 * @author 783661
	 *
	...
	private class MyActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			/*
			 * set all the panels to setVisible(false) so only the panel chosen will be
			 * visible.
			 */
