...
public class Client {
	 ...
	 * @throws InvalidPhoneNumberException for phone number format
	 * @throws InvalidPostalCodeException for postalCode
	 */
	public Client(long clientId,
				  ...
				  String postalCode,
				  String phoneNumber,
				  char clientType)  throws InvalidPhoneNumberException, InvalidPostalCodeException
	{
		setClientId(clientId);
		this.firstName = firstName;
		this.lastName = lastName;
		this.address = address;
		validatePostalCode(this.postalCode = postalCode);
		validatePhoneNumber(this.phoneNumber = phoneNumber);
	 ...
	 * @throws InvalidPhoneNumberException for phone number format
	 * @throws InvalidPostalCodeException for postal code format
	 */
	public Client(String line)  throws InvalidPhoneNumberException, InvalidPostalCodeException
	{
		 ...
		 */
		setClientId(Long.parseLong(theLine[0]));
	 ...
	 * @throws InvalidPostalCodeException for postal code
	 */
